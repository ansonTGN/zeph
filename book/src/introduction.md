...
- [Why Zeph?](why-zeph.md) — what sets Zeph apart from other agent frameworks
- [Installation](getting-started/installation.md) — all installation methods (source, binaries, Docker)
- [First Conversation](getting-started/first-conversation.md) — from zero to productive in 5 minutes
